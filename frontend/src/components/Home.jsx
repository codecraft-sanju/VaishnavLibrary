...
const Home = ({contactRef}) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between w-full h-full p-6 px-6 sm:px-12 md:px-16 lg:px-40 mt-32 font-bold md:flex-row">
      <div className="z-10 space-y-4 text-center text-white md:text-left md:w-1/2">
        <h2 className="text-[#08D665] text-xl sm:text-2xl md:text-3xl">HELLO!</h2>
        ...
        <p className="text-sm sm:text-base md:text-lg max-w-lg mx-auto md:mx-0 text-white">
        ...
        <button 
          ...
          className="text-white bg-[#08D665] p-3 rounded-md mt-4 sm:mt-6 md:mt-8 text-sm sm:text-base">
          Contact Me
        </button>
      </div>
